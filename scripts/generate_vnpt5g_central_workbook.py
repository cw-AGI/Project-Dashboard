...
def write_workbook(path: str, sites: list[dict], rolling: list[dict]) -> None:
    ...
    risks = [
        (
            "Cấp phép tần số / thủ tục địa phương",
            "Medium",
            "Một số trạ mở rộng chậm giấy phép xây dựng cột phụ tại Quảng Nam.",
            "Trần Hoài Nam",
            "2026-05-10",
            "Đang rà soát danh sách 12 trạ; 6 trạ đã có phê duyệt bổ sung.",
            "Phối hợp Sở TT&TT địa phương; ưu tiên đường dây nóng tuần 18.",
            PROJECT_ID,
        ),
        (
            "Logistics thiết bị RRH theo lô Q1",
            "High",
            "Lô RRH n78 bị lệch lịch cảng ảnh hưởng chuỗi lắp đặt tháng 3.",
            "Lê Thu Hà",
            "2026-04-28",
            "Điều chuyển một phần từ kho Singapore; 70% nhu cầu đã có mặt tại kho miền Trung.",
            "Xác nhận air-freight cho 40 RRH cuối chuỗi; cập nhật MOS plan tuần 17.",
            PROJECT_ID,
        ),
        (
            "Nguồn điện và chỗ phòng máy (expansion)",
            "Medium",
            "Một số trạ expansion cần nâng công suất nguồn trước On Air.",
            "Phạm Quốc Anh",
            "2026-05-05",
            "Survey điện hoàn tất 89%; 11 trạ đang chờ hợp đồng gia công tủ điện.",
            "Đẩy mua sắm tủ PDU đợt 2; lịch lắp tuần 16–17.",
            PROJECT_ID,
        ),
    ]
    for r in risks:
